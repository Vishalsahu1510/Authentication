...
export const getForgotPasswordHtml = ({ token }) => {
  const appName = process.env.APP_NAME || "Authentication App";
  const baseUrl = process.env.FRONTEND_URL || "http://localhost:5173";
...
<div style="display: inline-block; width: 64px; height: 64px; background: linear-gradient(135deg, #ef4444 0%, #dc2626 100%); border-radius: 50%; line-height: 64px; font-size: 28px;">🔑</div>
</div>
<h1 class="title" style="text-align: center;">Reset Your Password</h1>
...
<!-- Button -->
<table role="presentation" class="btn-wrap" border="0" cellspacing="0" cellpadding="0" width="100%">
<tr>
<td align="center">
...
<p class="warning-text">⚠️ This link will expire in <strong>5 minutes</strong>. If you didn't request a password reset, you can safely ignore this email.</p>
</div>
<p class="muted" style="text-align: center;">If the button doesn't work, copy and paste this link into your browser:</p>
